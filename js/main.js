...
window.onload = function () {
  ...
  var burger = document.querySelector('.icon-menu'),
      ...
      body = document.body,
      headerColumnLogomenu = document.querySelector('.header-column__logo'),
      im = document.querySelector('.im'),
      find = document.querySelector('.find');
  burger.addEventListener('click', function () {
    burger.classList.toggle('icon-menu__active');
    menu.classList.toggle('menu-mob_active');
    body.classList.toggle('no-scroll');
    headerColumnLogomenu.classList.toggle('blur');
    im.classList.toggle('blur');
    find.classList.toggle('blur');
  }); //////////////////////////////////////////////////
  ///===============================================================================swiper
